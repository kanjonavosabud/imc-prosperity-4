...
class Trader:
    ...
    COVER_MIN_SHORT      = 60   # only fire when |pos| ≥ this
    COVER_MIN_MTM        = 500  # only fire once MTM > this (modest)
    COVER_Z_THRESHOLD    = 0.2  # mid must be ≥ 0.2σ below recent rolling mean
    COVER_LOOKBACK       = 50   # # of mid_hist samples for rolling stats
    COVER_INNER_OFFSET   = 4    # ticks inside best_bid (vs default 1)
